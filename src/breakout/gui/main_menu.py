...
from breakout.config import SCREEN_HEIGHT, SCREEN_RESIZABLE, SCREEN_TITLE, SCREEN_WIDTH
...
class MainView(arcade.View):
    ...
    def __init__(self) -> None:
        ...
        def on_click_switch_button(_event: arcade.gui.UIEvent) -> None:
    ...
    def on_hide_view(self) -> None:
        """Run on switching out of the view."""
...
class MenuView(arcade.View):
    ...
    def __init__(self, main_view: arcade.View) -> None:
        ...
        def on_click_resume_button(_event: arcade.gui.UIEvent):
            """Pass already created view because we are resuming."""
            self.window.show_view(self.main_view)

        @start_new_game_button.event("on_click")
        def on_click_start_new_game_button(_event: arcade.gui.UIEvent):
            """Create a new view because we are starting a new game."""
            main_view = MainView()
            self.window.show_view(main_view)

        @exit_button.event("on_click")
        def on_click_exit_button(_event: arcade.gui.UIEvent):
            """Quit game."""
            arcade.exit()

        @volume_button.event("on_click")
        def on_click_volume_button(_event: arcade.gui.UIEvent):
            """Volume settings."""
            volume_menu = SubMenu(
                "Volume Menu",
        ...
        def on_click_options_button(_event: arcade.gui.UIEvent):
...
class SubMenu(arcade.gui.UIMouseFilterMixin, arcade.gui.UIAnchorLayout):
    ...
    def __init__(self,
        ...
        back_button.on_click = on_click_back_button
...
def on_click_back_button(self: arcade.gui.UIFlatButton, _event: arcade.gui.UIEvent) -> None:
...
class GameWindow(arcade.Window):
    ...
    def __init__(self,
                 ...
                 window_title: str = SCREEN_TITLE,
                 *,
                 resizable: bool = SCREEN_RESIZABLE) -> None:
        """Create main window."""
